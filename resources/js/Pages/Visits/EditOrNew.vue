    ...
    <app-layout>
        ...
        <div class="py-2" v-if="visit !=null">
            ...
            <div class="flex justify-end mr-15 mt-4" >
                <jet-button @click.native="planToBeInvoiced = true" v-if="!editing" class="bg-red-orange-400 hover:bg-red-orange-400 " :class="{'invisible' : !visit.invoiced && visit.vaccines.length == 0}">
