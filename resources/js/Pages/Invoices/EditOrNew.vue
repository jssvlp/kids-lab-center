                                        ...
                                        <td class="px-6 py-3 whitespace-nowrap">
                                            <div class="flex">
                                                ...
                                                <div v-if="!discountVisible" class="flex cursor-pointer ml-2" @click="modalDiscountVisible = true">
                                                    ...
                                                    <div class="ml-2 mt-1 text-red-orange-400">Aplicar covertura ARS</div>
                                                </div>
                                                <div class="flex mt-1 ml-1" v-if="discountVisible">
                                                    <span class="text-red-orange-600">- {{discount}}% descuento covertura ARS </span>
