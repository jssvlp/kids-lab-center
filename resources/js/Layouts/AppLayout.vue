            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="flex-shrink-0 flex items-center">
                            <inertia-link :href="route('dashboard')">
                                <img src="/Images/logo-name.png" width="100px" class="logo-border" alt="">
                            </inertia-link>
                        </div>
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <jet-nav-link class="text-white" :href="route('dashboard')" :active="route().current('dashboard')">
                                 <div class="flex hover:text-red-orange-300 text-white">
                            ...
                            <jet-nav-link class="text-white" ref="" :href="route('visits.index')" :active="route().current('visits.index')">
                                <div class="flex hover:text-red-orange-300 text-white">
                                    ...
                                    <div class="ml-1">Visitas</div>
                                </div>
                            </jet-nav-link>
                            <jet-nav-link  ref="" :href="route('invoices.index')" :active="route().current('invoices.index')">
                                <div class="flex hover:text-red-orange-300 text-white  focus:text-red-orange-400 focus:border-red-orange-200 ">
                            ...
                            <div class="ml-3 relative">
                                <jet-dropdown align="right" width="48">
                                    <template #trigger>
                                        <button v-if="$page.jetstream.managesProfilePhotos" class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-red-orange-400 transition duration-150 ease-in-out">
                                            <img class="h-8 w-8 rounded-full object-cover" :src="$page.user.profile_photo_url" :alt="$page.user.name" />
                                        </button>
                                        <button v-else class="flex items-center text-sm font-medium text-gray-50 hover:text-red-orange-300 hover:border-pra-300 focus:outline-none focus:text-red-orange-400 focus:border-red-orange-200 transition duration-150 ease-in-out">
                                            <div class="flex">
                                    ...
                                    <template #content>
                                        <!-- Account Management -->
                                        <div class="block px-4 py-2 text-xs text-red-orange-400">
                    ...
                    <div class="-mr-2 flex items-center sm:hidden">
                        <button @click="showingNavigationDropdown = ! showingNavigationDropdown" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-red-orange-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
